...
public class AdminUpdateAccountController extends HttpServlet {
    ...
    private static final String SUCCESS = "AdminSearchAccountController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RegistrationDTO dto = new RegistrationDTO(username, fullname, email, phoneNo, role);
            boolean check = dao.update(dto);
            if(check) url=SUCCESS;
            else request.setAttribute("ERROR", "Can not update");
        } catch (Exception e) {
            log("Error at update Account " + e.getMessage());
        } finally {
